    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex justify-between">
        ...
        <button onClick={() => addItem(wixClient, productId, variantId, quantity)}
         className="w-36 text-sm rounded-3xl ring-1 ring-valens text-valens py-2 px-4 hover:bg-valens hover:text-white disabled:cursor-not-allowed disabled:bg-pink-200 disabled:ring-0 disabled:text-white disabled:ring-none" disabled={isLoading}>Add to Cart</button>
      </div>
    </div>
  );
